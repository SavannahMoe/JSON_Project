...
print(multiplied)
#must use consistent wording in the expression to make it work
...
listOfWords = ['this', 'is', 'a','list', 'of', 'words']
        #below is using a index to access the frist letter of each word and creating a list
...
numbers = [x for x in string if x.isdigit()] #checks if this is a digit 
...
i = [double(x) for x in range(10) if x %2 == 0] #expression, iteration (range), and valuation 
print(i)
